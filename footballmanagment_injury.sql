...
CREATE TABLE `injury` (
  ...
  `injury_status` int DEFAULT NULL,
  `person_id` int NOT NULL,
  PRIMARY KEY (`person_id`,`injury_type`,`injury_date`),
  CONSTRAINT `injury_ibfk_1` FOREIGN KEY (`person_id`) REFERENCES `athlete` (`person_id`) ON DELETE CASCADE
...
INSERT INTO `injury` VALUES ('Arm','2022-04-20',0,67),('ACL','2023-10-15',1,68),('Leg','2022-09-21',0,69),('Back','2021-05-07',0,70),('Head','2021-10-30',1,71),('Finger','2022-01-22',0,72);
